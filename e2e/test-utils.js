...
const TOURNAMENT_CONTROLLER_CONTRACT = '0x6ff88C9b5ac4A1551e7d095c546B4f090d0DFB8F';
...
async function login(page, privateKey) {
    ...
    await page.route('**/api/auth/nonce', route => route.fulfill({
        status: 200,
    ...
    await expect(page.getByRole('button', { name: 'PvP Ranqueado' })).toBeVisible({ timeout: 10000 });
