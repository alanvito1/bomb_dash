...
export default class WorldMapScene extends Phaser.Scene {
    ...
    create() {
        // 1. Background
        this.add.image(this.scale.width / 2, this.scale.height / 2, 'menu_bg_vertical')
            .setOrigin(0.5)
            .setDisplaySize(480, 800);

        // 2. Header
        this.add.text(this.scale.width / 2, 50, 'WORLD MAP', {
    ...
    renderMap() {
        ...
        Stages.forEach(stage => {
            ...
            const node = this.add.image(stage.x, stage.y, 'btn_menu')
                .setOrigin(0.5)
            ...
            // Text Label
            this.add.text(stage.x, stage.y, stage.id.toString(), {
                fontFamily: '"Press Start 2P"',
                fontSize: '16px',
            ...
            // Name Label (below)
            this.add.text(stage.x, stage.y + 35, stage.name, {
                fontFamily: '"Press Start 2P"',
                fontSize: '10px',
        ...
        // Back Button
        const backBtn = this.add.image(60, 50, 'btn_menu') // Reusing btn_menu or creating a simple text
            .setOrigin(0.5)
            .setScale(0.5)
