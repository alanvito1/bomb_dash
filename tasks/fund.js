...
task("fund", "Funds an account with MockBCOIN")
    ...
    .setAction(async (taskArgs, { ethers }) => {
        ...
        if (!fs.existsSync(addressesPath)) {
            console.error("Could not find contract-addresses.json. Make sure contracts are deployed.");
            return;
        }
        ...
        console.log(`Success! New balance: ${ethers.formatUnits(balance, 18)} BCOIN`);
    });
